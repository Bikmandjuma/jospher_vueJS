          ...
          <div class="card border rounded-lg shadow-md mt-4">
            <div class="card-body p-1">
              <div  style="max-height: 400px;overflow: auto;">
                <h4 class="text-center sticky top-0 z-10 p-2 bg-white">Job Categories&nbsp;<span class="badge bg-primary" style='border-radius: 50%;'>{{ jobDataCategories.length }}</span></h4>
